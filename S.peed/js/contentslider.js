...
var csloadstatustext="<img src='<?php bloginfo('template_directory'); ?>/images/loading.gif' /> Requesting content..." //HTML to indicate Ajax page is being fetched
...
ContentSlider.buildpagination=function(sliderid){
	...
	pcontent+='<a href="#" style="font-weight:normal;" onClick=\"ContentSlider.turnpage(\''+sliderid+'\', parseInt(this.getAttribute(\'rel\'))); return false\">'+(slider.nextText || "Next")+'</a>'
