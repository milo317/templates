...
var iBox = function()
{
  var _pub = {
    ...
    reposition: function(e)
    {
      ...
      els.overlay.style.height = document.body.clientHeight + 'px';
    },
    ...
    getPageSize: function()
    {
      var docElem = document.documentElement;
      return {
        width: (window.innerWidth && window.innerWidth - 16) || (document.documentElement && document.documentElement.clientWidth) || document.body.clientWidth,
        height: (window.innerHeight && window.innerHeight - 16) || (document.documentElement && document.documentElement.clientHeight) || document.body.clientHeight
      };
    },
  ...
  var hideTags = function(tag)
  {
    ...
    {
      if (list[i].style.visibility == 'visible' && list[i].style.display != 'none')
      {
  ...
  var iBoxPlugin_Container = function()
  {
    return {
      ...
      render: function(url, params)
      {
        ...
        {
          _pub.html(elemSrc.innerHTML, params);
        }
      }
    }
  }();
